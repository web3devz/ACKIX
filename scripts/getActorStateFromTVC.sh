...
CONFIG_PATH=~/src/Ackixhouse/scripts/tonos-cli.conf.json
SOURCE="$1"
TVC="$2"
...
if [ $# -ne 3 ]; then
    ...
    echo
    echo "Prints Ackixhouse actor state according to the definition of typeName"
...
~/src/Ackixhouse/src/LHGenDes/bin/Debug/net6.0/LHGenDes $SOURCE $TYPENAME
